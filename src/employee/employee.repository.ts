...
export class EmployeeRepository {
    ...
    async findOne(employeeFilterQuerry: FilterQuery<Employee >): Promise<Employee> {
    ...
    async findOneAndUpdate(employeeFilterQuerry: FilterQuery<Employee>, employee: Partial<Employee>): Promise<Employee> {
